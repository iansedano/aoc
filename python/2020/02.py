...
for line in lines:
	...
	frequency_range, letter = policy.split(" ")
	frequency_range = frequency_range.split("-")
	frequency_range = range(int(frequency_range[0]), int(frequency_range[1]) + 1)


	count = password.count(letter)

	if count in frequency_range:
		valid_passwords += 1
	else:
		invalid_passwords += 1

print("valid", valid_passwords, "invalid", invalid_passwords)
...
for line in lines:
	...
	position_1, position_2 = positions.split("-")
	pass_pos_1 = password[int(position_1) -1]
	pass_pos_2 =  password[int(position_2) -1]

	
	check = (
		(pass_pos_1 == letter and pass_pos_2 != letter) or
		(pass_pos_1 != letter and pass_pos_2 == letter)
		)
...
print("valid (322 too low)", valid_passwords, "invalid", invalid_passwords)